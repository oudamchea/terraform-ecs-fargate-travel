...
resource "aws_ecs_cluster" "travel" {
...
resource "aws_ecs_cluster_capacity_providers" "example" {
  cluster_name = aws_ecs_cluster.travel.name
...
resource "aws_ecs_task_definition" "travel" {
  family                   = var.family
...
resource "aws_ecs_service" "travel" {
  name            = var.cluster_name
  cluster         = aws_ecs_cluster.travel.id
  task_definition = aws_ecs_task_definition.travel.arn
